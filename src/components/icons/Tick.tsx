...
const Tick = ({ width, color }: Props): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="3 3 16 16" width={width}>
      <defs>
        <linearGradient
      ...
      <g transform="matrix(1.99997 0 0 1.99997-10.994-2071.68)" fill="#da4453">
        <rect y="1037.36" x="7" height="8" width="8" fill={color} rx="4" />
        <path
